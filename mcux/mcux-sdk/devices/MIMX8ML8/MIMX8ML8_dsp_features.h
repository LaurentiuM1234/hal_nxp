...
/* @brief The start IRQ index of the first IRQSTEER source IRQ */
...
/* @brief Theoretical number of interrupts aggregated by each master
 *
 * In practice, master 0 aggregates 32 interrupts, while master 1 and
 * 2 aggregate 64 interrupts each
 */
#define FSL_FEATURE_IRQSTEER_MASTER_IRQ_NUM (64)
